...
(* OASIS_START *)
(* DO NOT EDIT (digest: fc51214eca1cf789af3b63e13c3bd80c) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("sh", ["test.sh"]))];
     ...
     package =
       {
          ...
          build_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("ocaml", ["gen_files.ml"])))];
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("cp",
                           ["_build/src/evilmlJS.js"; "html/js/evilml.js"])))
                 ]
            };
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = [];
                      bs_data_files = [("../includes/*.hpp", None)];
                   ...
                   {exec_custom = false; exec_main_is = "evilml.ml"});
               Executable
                 ({
                     cs_name = "evilmlJS";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "evilmlJS.ml"});
               Test
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\180\229\141\249\210\164NY\202$\029\200\200\029]G";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
