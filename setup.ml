...
(* OASIS_START *)
(* DO NOT EDIT (digest: e2b51dacbb8b98a5834ee907abcff8a0) *)
(*
...
let setup_t =
  {
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("cp", ["_build/src/evilml.js"; "html/js/"])))
                 ]
            };
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\000\153\227\005\179w\021\1717+\240>\221\0231\153";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
