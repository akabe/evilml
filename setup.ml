...
(* OASIS_START *)
(* DO NOT EDIT (digest: 48e9c3df3faf94b8374dd525706005ed) *)
(*
...
let setup_t =
  {
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("cp", ["_build/src/jsmain.js"; "html/js/"])))
                 ]
            };
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "jsmain.ml"})
            ];
          plugins =
            [
               (`Extra, "META", Some "0.4");
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\202\019\003\241\163\155\196\165\161\170\238\029vW\224\239";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
